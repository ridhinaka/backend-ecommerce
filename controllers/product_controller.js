...
var productController = /** @class */ (function () {
    ...
    productController.add_product = function (req, res) {
        var newProduct = {
        ...
        Products_1.Product.create(newProduct)
    ...
    productController.get_product = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var findProduct;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, Products_1.Product.find({})];
                    case 1:
                        findProduct = _a.sent();
